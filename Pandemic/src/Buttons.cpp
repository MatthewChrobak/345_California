        ...
        case PlayerActions::CharterFlight:
            ...
            if (this->_cardData->size() == 1) {
                ...
                if (card->getType() == PlayerCardType::City_Card) {
                    ...
                    ///TODO GUI CARD SELECTION! NEED THE VALUE HERE
                    int clickedCityIndex;

                    std :: cout << "Enter the name of the city you would like to move to" << endl;
                    std::string cityName;
                    ...
                    player.setCitySelected(clickedCityIndex);
            ...
            if (Game::numOfResearchCenter > 0) {
                ...
                //int x = player.getRoleCard()->getRoleCardVal();
                 ...
                 if (this->_cardData->size() != 1)
                    ...
                    else if (card != nullptr && card->getType() == PlayerCardType::City_Card && roleCardIndex != 4) {
