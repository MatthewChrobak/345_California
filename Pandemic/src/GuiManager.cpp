...
//	if (GuiManager::_messageBox.getVisible()) {
...
//
//		if (element->visible) {
//			if (element->getLeft() <= x && element->getLeft() + element->getWidth() >= x) {
//				if (element->getTop() <= y && element->getTop() + element->getHeight() >= y) {
//
...
//}
//
//void // TODO: MVC DOES NOT ALLOW THIS:  GuiManager::showMsgBox(std::string message)
//{
